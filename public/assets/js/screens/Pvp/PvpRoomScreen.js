...
class PvpScreen extends BaseComponent {
    constructor() {
        super();
    }
                ...
                <div class="screen-main">
                    <div class="screen-content">
                        ...
                        <div class="pvp-room-panel">
                            <div class="list-room-title">Danh sách phòng thi đấu</div>
                                    ...
                                    <div class="pvp-list-room">
                                        <div class="room-item">
                                            ...
                                            <div class="room-meta">
                                                ...
                                                <a href="${config.domain}pvp/" class="room-fight">
                                                    <img src="${config.img_dir}screens/pvp/fight.png" alt="pvp-fight">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="room-item">
                            ...
                            <div class="pvp-control">
                                <a href="${config.domain}#!/pvp/rank" class="btn">
                                    <img src="${config.img_dir}screens/pvp/btn-rank.png" alt="btn-rank">
                                </a>
                                <button class="btn btn-creat-room">
                                    <img src="${config.img_dir}screens/pvp/btn-creat-room.png" alt="btn-create-room">
                                </button>
                            </div>
                        </div>
                    </div>
...
window.customElements.define('pvp-screen', PvpScreen);
